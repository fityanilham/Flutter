      ...
      body: ListView.builder(
        ...
        itemBuilder:(context,index){
          return ListTile(
            ...
            onTap: (){
              Navigator.push(
                context, MaterialPageRoute(builder: (context) => Contact(name:name[index], number:number[index], status: status[index],)),
              );
            },
          );
        },
...
class Contact extends StatelessWidget {
  ...
  Contact({Key key, @required this.name, this.number, this.status}) : super(key: key);
